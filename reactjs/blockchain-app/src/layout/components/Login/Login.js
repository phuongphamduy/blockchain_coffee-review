                        ...
                        <div className="card-body p-4 p-sm-5">
                            ...
                            <form>
                                ...
                                <div className="d-grid mb-2">
                                    <button className="btn btn-google btn-login text-uppercase fw-bold bg-danger text-white fs-4" type="submit">
                                        < FontAwesomeIcon icon={faGoogle} /> <span style={{ marginLeft: '8px' }}></span> Sign in with Google
                                    </button>
                                </div>
                                <div className="d-grid">
                                    <button className="btn btn-facebook btn-login text-uppercase fw-bold bg-primary text-white fs-4" type="submit">
                                        <FontAwesomeIcon icon={faFacebookF} /> <span style={{ marginLeft: '8px' }}></span> Sign in with Facebook
                                    </button>
                                </div>
                            </form>
                        </div>
